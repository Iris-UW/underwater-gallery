...
const GALLERY_I18N = {
  ...
  ui: {
    ...
    admin_login_hint: { en: 'Enter password to access admin', zh: '请输入密码以访问管理页面', ja: '管理者ページはパスワードが必要です' },
    admin_login_btn: { en: 'Enter', zh: '进入', ja: '入室' },
    admin_pwd_placeholder: { en: 'password', zh: '请输入密码', ja: 'パスワード' },
    ...
    contact_email: { en: '✉ Email', zh: '✉ 邮箱', ja: '✉ メール' },
    contact_xhs: { en: '📕 XiaoHongShu', zh: '📕 小红书', ja: '📕 小紅書' },
